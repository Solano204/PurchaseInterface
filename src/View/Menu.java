...
public class Menu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        m_historial.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                m_historialMouseClicked(evt);
            }
        });
    ...
    private void m_historialMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_m_historialMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_m_historialMouseClicked

    private void administracionMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_administracionMouseClicked
        lets = new usuario02();
        lets.setMenu(this);
        this.setVisible(false);
        lets.setLocationRelativeTo(null);
